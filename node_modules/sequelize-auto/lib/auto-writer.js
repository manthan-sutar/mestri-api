    ...
    createAssociations(typeScript) {
        ...
        rels.forEach(rel => {
            if (rel.isM2M) {
                ...
                strBelongsToMany += `${sp}${rel.parentModel}.belongsToMany(${rel.childModel}, { through: ${rel.joinModel}, foreignKey: "${rel.parentId}", otherKey: "${rel.childId}" });\n`;
            }
            else {
                ...
                const bAlias = this.options.noAlias ? '' : '';
                ...
                const hAlias = this.options.noAlias ? '' : '';
